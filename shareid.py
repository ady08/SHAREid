...
Nama      : SHAREid
Versi     : 1.0
Date      : November 11th, 2019 3:17:30 WIB 
Author    : Edy Naibaho
Code      : 01g
Grup      : SAMOSIR CYBER TEAM
Lisensi   : Gratis
Thanks to : Nicoleus Sitorus Dan SAMOSIR CYBER TEAM,
...
More      : Tool ini sengaja dibuat untuk mempermudah
            ...
            milik @Nicoleus untuk mendapat tokennya.
                        
* Masih banyak error yang terjadi.          
* Silahkan bully saya ke Edy Naibaho
...
def header():
      ...
      print(lc+"         //\\||  ==== () ")  
      print(lc+"        /`  \\|  ='=  `| "+lr+"-Edy Naibaho-")
      print(lc+"      =='    `"+lr+"("+x+"KJ4"+lr+")"+lc+"   '--"+x)
      print(lr+"      ==================================="+x)
      print(lc+"        SHARE"+x+"id"+lr+" v1.0"+a+" by: Nicoleus Sitorus")
      print(lr+"      ==================================="+x)
      print(lc+"""
      1. Mulai
